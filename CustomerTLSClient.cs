...
namespace ExampleServer
{
    ...
    for( int Count = 0; Count < 100; Count++ ) // There won't be 100 messages in it.
      ...
      switch( MessageType )
        ...
        case 2: // ServerHello
          ...
          Index = ProcessHandshakeServerHello( Index );
          if( Index < 1 )
        ...
        case 11: // Certificate
          // Index = ProcessX509Certificate( Index );
          // if( Index < 1 )
            // return true; // Usually it's an error.
  ...
  private int ProcessHandshakeServerHello( int Index )
    {
    try
    {
